...
def create_static_mapping_entry(mac_address, hostname, description, logger):
    """
    ...
    try:
        ...
        logger.error(f"pfSense API request error: {e}")
        return False, f"pfSense API error: {e}", None
